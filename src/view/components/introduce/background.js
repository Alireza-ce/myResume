...
useEffect(() => {
	...
	tl.from(sPath,{y:100,duration:2,opacity:0,delay:3})
	...
	return (
		<Svg ref={ref} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		 viewBox="0 0 450 450" enableBackground="new 0 0 450 450" xmlSpace="preserve">
	...
	<path ref={el => (fPath = el)} className="st0" style={{ fill: 'url(#SVGID_1_)' }} d="M449.82,448.85V1.15H4.94c0,0-32.3,87,68.25,48.33c100.55-38.67,84.97,14.7,71.41,41.58
	...
	<path ref={el => (sPath = el)} style={{ fill: 'url(#SVGID_2_)'}}  className="st1" d="M449.91,448.92V1.22h-98.84c0,0-120.38-7.53-141.81,87.39c-23.35,103.43,51.34,152.07,76.67,128.32
