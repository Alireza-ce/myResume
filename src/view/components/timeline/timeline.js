    ...
    <Main id="main">
      ...
      <Ul>
        <Li>
          ...
          <P>I was in charge of implementing the front side of a data management system used by doctors in hospital research centers all over Iran. The goal was to create a system that could easily be used by doctors who do not know how to use new technologies very well. 
            </P> 
            {imagesDaft("daft")}
          </Content>
        ...
        <Li>
          <Content>
            <H3>Full Stack Developer <small>(Intern)</small></H3>
           <Company>
             <Icon />
          ...
          <P>Devloped the front-end and also the back-end of two seperate applications which tracked the location of the employees in the company while they were on duty. The first application was used by the employee and the other one was used by the company's manager. 
            </P> 
            {imagesDaft("it")}
          </Content>
          <Time>jan 2019</Time>
